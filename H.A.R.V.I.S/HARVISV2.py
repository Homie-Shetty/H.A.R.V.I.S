...
from ctypes import windll  # For brightness control
...
def set_brightness(level):
    ...
    windll.user32.SetMonitorBrightness(0, level)
...
def execute_command(command, root):
    ...
    if "open youtube" in command:
        ...
        play_audio("Setting volume to maximum.mp3")
        set_volume(100)
    elif "mute volume" in command:
        play_audio("Muting volume.mp3")
        mute_volume()
